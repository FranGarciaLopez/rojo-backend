...
const io = new Server(server, {
  cors: {
    origin: ["https://rojo-frontend.onrender.com", "http://localhost:5173"],
...
// MongoDB connection
const mongoDB = `mongodb+srv://${process.env.DB_USER}:${encodeURIComponent(
  process.env.DB_PASSWORD
)}@${process.env.DB_SERVER}/${process.env.DB_NAME}?retryWrites=true&w=majority`;
